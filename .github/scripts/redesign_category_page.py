...
marker = 'class _CategorySection extends StatelessWidget {'

if marker not in text:
    raise SystemExit('Category section marker not found')

prefix = text.split(marker, 1)[0]
replacement = r'''class _CategorySection extends StatelessWidget {
