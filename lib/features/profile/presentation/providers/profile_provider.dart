...
// }
  ...
  try {
    ...
    debugPrint(
      'Firestore tags mirror failed: $e',
    );
  }
}
...
Future<void> updateLanguages(
  ...
  try {
    ...
    debugPrint(
      'Firestore languages mirror failed: $e',
    );
  }
}
...
Future<void> updateAvatar(
  ...
  try {
    final downloadUrl =
        await _storageService.uploadAvatar(imageFile);
    ...
    if (oldAvatarUrl.isNotEmpty &&
      ...
      try {
        await _storageService.deleteOldAvatar(
          oldAvatarUrl,
        );
      } catch (e) {
