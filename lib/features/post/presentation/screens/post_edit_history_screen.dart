...
class PostEditHistoryScreen extends StatelessWidget {
  final String postId;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        stream: service.watchEditHistory(postId),
        builder: (context, snapshot) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final timestamp = data['editedAt'] as Timestamp?;
              ...
              return ListTile(
                ...
                title: Text(_formatTime(timestamp)),
                subtitle: Column(
...
class _PostHistoryDetailScreenState extends State<_PostHistoryDetailScreen> {
  ...
  void initState() {
    ...
    final bodyDelta =
        (widget.data['bodyDelta'] as List<dynamic>?)?.map((e) => e).toList() ??
        const [];
